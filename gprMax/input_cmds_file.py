...
def check_cmd_names(processedlines, checkessential=True):
    ...
    multiplecmds = {key: [] for key in ['#geometry_view', '#material', '#soil_peplinski', '#add_dispersion_debye', '#add_dispersion_lorentz', '#add_dispersion_drude', '#waveform', '#voltage_source', '#hertzian_dipole', '#magnetic_dipole', '#transmission_line', '#sma_transmission_line', '#monopole_coaxial', '#rx', '#rx_array', '#snapshot', '#pml_cfs']}
